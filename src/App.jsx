      ...
      <div className="fixed z-2 lg:left-[5%] rounded-b-2xl top-0 bg-gray-800 w-[100%] lg:w-[90%] h-[100px] m-auto px-[20px] py-[20px] flex justify-between items-center">
        <div className="">
          ...
          <select
            ...
            id=""
            className="text-[#fff] bg-[black] mx-[10px] border-1 py-[5px] rounded-md"
          >
      ...
      >
        <Table sx={{ xs: "70%", md: "100%" }}>
          <TableHead>
            <TableRow
              sx={{ color: "#fff" }}
              className="border-1 bg-gray-500 text-[#fff]"
            >
          ...
          <TableBody>
            {users.length == 0 ? (
              <h1 className="text-[70px] text-red-700 font-bold absolute text-center lg:left-[35%]">
                NOT FOUND
              </h1>
            ) : (
              users.map((user) => {
                  ...
                  >
                    ...
                    <TableCell className="w-[100px] text-center">
                      <p
                        className={
                          user.status
                            ? "rounded-md text-center py-[10px] bg-green-500 text-[#fff] font-bold"
                            : "text-center py-[10px] rounded-md bg-red-500 text-[#fff] font-bold"
                        }
                      >
                        {user.status ? "Active" : "Inactive"}
                      </p>
                    </TableCell>
                    <TableCell className="font-bold lg:w-[100px]">
                      {user.email}
                    </TableCell>
                    <TableCell className="font-bold lg:w-[100px]">
                      {user.city}
      ...
      >
        <form className="flex flex-col items-center justify-center gap-[15px]">
          <input
            ...
            className="border-1 py-[5px] w-full"
            placeholder="Name..."
          />
          <input
            label="Name"
